...
import thread.threads.MyThread;
import thread.threads.MyThreadWhile;
...
public class MainThread {
    public static void main(String[] args) {
        // Создаём поток через MyThread extends Thread
         Thread myThread11 = new Thread("Thread1");
        ...
        Thread myThreadL = new Thread(
                ...
                "ThreadL");
        myThreadL.start();
        myThreadL.setPriority(MIN_PRIORITY);
        ...
        Thread myThread3 = new Thread(myThreadWhile,"MyThreadWHILE");
        myThread3.start();
